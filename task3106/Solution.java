...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        for (String name : fileNames) fileInputStreams.add(new FileInputStream(name));

        //Входящий стрим общего архива
        try (ZipInputStream is =
                     new ZipInputStream(new SequenceInputStream(Collections.enumeration(fileInputStreams)))) {
            while (true) {
